...
async def cmd_start(message: Message, state: FSMContext):
    ...
    # New User Flow
    welcome_text = (
        """🔹اینجا مجموعه‌ای از محتوای آموزشی مبتنی بر روان‌شناسی ACT در اختیار شما قرار می‌گیرد.
👈🏼این ربات کمک می‌کند با افکار و هیجان‌ها آگاهانه‌تر برخورد کنید، الگوهای رفتاری‌تان را بهتر بشناسید و مسیر یادگیری شخصی‌تان را مرحله‌به‌مرحله دنبال کنید.

📌محتواها شامل فایل‌های صوتی، ویدیویی، تمرین و آزمون هستند و به‌صورت تدریجی در دسترس قرار می‌گیرند.
